<?php
 ...
 if(!empty($_GET["qid"]))
 {
	...
	$sql2="select an.acont, an.up, an.down, ac.username from answers as an inner join accounts as ac on an.userid=ac.userid where an.qid='$qid'";
